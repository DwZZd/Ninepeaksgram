    ...
    present: @escaping (ViewController, Any?) -> Void) -> GalleryItem?
{
    ...
    if let _ = media as? TelegramMediaImage {
        ...
        if file.isVideo {
            ...
            let captureProtected = !MiscSettingsManager.shared.shouldBypassScreenshotProtection && (message.isCopyProtected() || message.containsSecretMedia || message.minAutoremoveOrClearTimeout == viewOnceTimeout || message.paidContent != nil)
            if file.isAnimated {
